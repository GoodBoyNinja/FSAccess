var makePalette = function(validator, grantedCallback, options) {
    ...
    // palette and groups
    webAccessPalette = new Window("palette", undefined, undefined, {
        closeButton: true,
        resizeable: false,
    });
    ...
    var highlightedText = row1.add(
        "statictext",
        undefined,
        osMenuName + " -> Preferences -> Scripting & Expressions -> Allow Scripts to Write Files and Access Network ", {
            name: "statictext2",
        }
    );
    row3.add(
    ...
    // colorize the text
    var dimPen = webAccessPalette.graphics.newPen(
        webAccessPalette.graphics.PenType.SOLID_COLOR,
        [1, 1, 1, 0.3],
        2
    );
    var orangePen = webAccessPalette.graphics.newPen(
        webAccessPalette.graphics.PenType.SOLID_COLOR,
        [1, 0.4, 0, 1],
        2
    );
    var whitePen = webAccessPalette.graphics.newPen(
        webAccessPalette.graphics.PenType.SOLID_COLOR,
        [1, 1, 1, 1],
        1
    );
